...
<li class="contenttimes"><strong><a href="http://www.1001metm.com/auvergne/sommaire_sp.php" target="_blank">Un <em>Corpus topo-fotográfico de los capiteles</em></a></strong> presenta, para cada iglesia, un mapa que permite visualizar, localizar y comparar la totalidad de los capiteles del edificio.<br />&nbsp;</li>
      ...
      <li class="contenttimes"><strong><a href="http://imagesrevues.revues.org/1579" target="_blank"><em>Iter et Locus. </em>Lugar ritual y disposición de los capiteles en las iglesias románicas de Auvergne</a></strong> propone un estudio global de la ornamentación esculpida de cada iglesia y una metodología para analizar su disposición, en relación con la constitución del edificio eclesial. <br/>&nbsp;
      </li>
      ...
      <p class="apropos"><br/>
        &nbsp;&nbsp;
              <a href="presentation_sp.php" alt="Presentation del sitio" target="_blank">Presentacion del sitio</a> <br/>
    </p>
