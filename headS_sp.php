...
<div id="titre">Iglesias románicas de Auvergne :  corpus topo-fotográfico de los capiteles</div>
<table  width="100%" border="0" padding="0" margin="0">
<tr width="100%">
<td width="70%" align="left">
<font class="menu_h">Lista de los edificios presentados</font>
</td>
<td width="100%" align="right">
        <li class="lpasDispo"><a href="sommaire.php">FR</a></li>
<li class="lpasDispo"><a href="sommaire_en.php">EN</a></li>
