...
function popupAnn(ItemId){

    var TheArea = document.getElementById('Area_' + ItemId);
// displays a popUp only if there is no Annotation currently displayed
    var realAnn = document.getElementById('Ann_' + ItemId);
    var TheMenuItem = document.getElementById('MenuItem_' + ItemId);

	if (TheMenuItem.className != 'SelectedAnnMenuItem'){


	var TheAnnotation = document.getElementById('popUp_' + ItemId);
//Position the Ann div (try to keep it on the image itself)
    if (TheAnnotation != null){
