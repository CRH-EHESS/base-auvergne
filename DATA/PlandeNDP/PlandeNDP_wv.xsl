...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Notre-Dame-du-Port (Plan de la collégiale)</xsl:variable>
    <xsl:variable name="DocFileName">PlandeNDP</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">543</xsl:variable>
    <xsl:variable name="ZoomImageWidth">2393</xsl:variable>
    <xsl:variable name="ZoomImageHeight">1623</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.334308</xsl:variable>
    <xsl:variable name="ScaledImageFileName">PlandeNDP_wv_Plan de NdP_wv_zoom_N-du-Pt plan def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">PlandeNDP_wv_zoom_Plan de NdP_wv_zoom_N-du-Pt plan def.jpg</xsl:variable>
