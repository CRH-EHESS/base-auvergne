...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Notre-Dame d'Orcival (plan des parties hautes)</xsl:variable>
    <xsl:variable name="DocFileName">orcival-partieshauttes</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">471</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1024</xsl:variable>
    <xsl:variable name="ZoomImageHeight">603</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.78125</xsl:variable>
    <xsl:variable name="ScaledImageFileName">orcival-partieshauttes_wv_Plan d'Orcival parties hautes_wv_zoom_plan orcival parties hautes.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">orcival-partieshauttes_wv_zoom_Plan d'Orcival parties hautes_wv_zoom_plan orcival parties hautes.jpg</xsl:variable>
