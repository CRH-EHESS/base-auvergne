...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Saint-Pierre de Mozat (plan de l'abbatiale)</xsl:variable>
    <xsl:variable name="DocFileName">plan-de-mozat</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">451</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1412</xsl:variable>
    <xsl:variable name="ZoomImageHeight">796</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.566572</xsl:variable>
    <xsl:variable name="ScaledImageFileName">plan-de-mozat_wv_Plan de Mozat_wv_zoom_MOZAT def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">plan-de-mozat_wv_zoom_Plan de Mozat_wv_zoom_MOZAT def.jpg</xsl:variable>
