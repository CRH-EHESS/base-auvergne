...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Saint-Marcellin de Chanteuges (plan de l'abbatiale)</xsl:variable>
    <xsl:variable name="DocFileName">Saint-MarcellindeChanteuges-plandelabbatiale</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">542</xsl:variable>
    <xsl:variable name="ZoomImageWidth">1417</xsl:variable>
    <xsl:variable name="ZoomImageHeight">960</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.564573</xsl:variable>
    <xsl:variable name="ScaledImageFileName">Saint-MarcellindeChanteuges-plandelabbatiale_wv_Plan de Chanteuges_wv_zoom_chanteuges plan def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">Saint-MarcellindeChanteuges-plandelabbatiale_wv_zoom_Plan de Chanteuges_wv_zoom_chanteuges plan def.jpg</xsl:variable>
