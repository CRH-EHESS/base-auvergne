...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Plan de Saint-Nectaire (parties hautes)</xsl:variable>
    <xsl:variable name="DocFileName">Plan-de-Saint-Nectaire-parties-hautes</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">448</xsl:variable>
    <xsl:variable name="ZoomImageWidth">2332</xsl:variable>
    <xsl:variable name="ZoomImageHeight">1307</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.343053</xsl:variable>
    <xsl:variable name="ScaledImageFileName">Plan-de-Saint-Nectaire-parties-hautes_wv_Plan de NdP parties hautes_wv_zoom_NDPplanPartiesHautes.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">Plan-de-Saint-Nectaire-parties-hautes_wv_zoom_Plan de NdP parties hautes_wv_zoom_NDPplanPartiesHautes.jpg</xsl:variable>
