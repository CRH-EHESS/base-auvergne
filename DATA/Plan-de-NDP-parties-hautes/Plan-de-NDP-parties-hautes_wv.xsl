...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Plan de Notre-Dame-du-Port (parties hautes)</xsl:variable>
    <xsl:variable name="DocFileName">Plan-de-NDP-parties-hautes</xsl:variable>
    ...
    <xsl:variable name="ScaledImageFileName">Plan-de-NDP-parties-hautes_wv_Plan de NdP parties hautes_wv_zoom_NDPplanPartiesHautes.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">Plan-de-NDP-parties-hautes_wv_zoom_Plan de NdP parties hautes_wv_zoom_NDPplanPartiesHautes.jpg</xsl:variable>
