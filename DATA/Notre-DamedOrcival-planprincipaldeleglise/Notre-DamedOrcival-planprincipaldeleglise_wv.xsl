...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Notre-Dame d'Orcival (plan principal de l'église)</xsl:variable>
    <xsl:variable name="DocFileName">Notre-DamedOrcival-planprincipaldeleglise</xsl:variable>
    <xsl:variable name="ScaledImageWidth">800</xsl:variable>
    <xsl:variable name="ScaledImageHeight">521</xsl:variable>
    <xsl:variable name="ZoomImageWidth">4634</xsl:variable>
    <xsl:variable name="ZoomImageHeight">3020</xsl:variable>
    <xsl:variable name="ImageScaleFactor">0.172637</xsl:variable>
    <xsl:variable name="ScaledImageFileName">Notre-DamedOrcival-planprincipaldeleglise_wv_Plan d'Orcival_wv_zoom_ORCIVAL A plan def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">Notre-DamedOrcival-planprincipaldeleglise_wv_zoom_Plan d'Orcival_wv_zoom_ORCIVAL A plan def.jpg</xsl:variable>
