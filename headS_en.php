...
<div id="titre">Romanesque Churches of Auvergne :  Topo-photographic Corpus of Capitals</div>
<table  width="100%" border="0" padding="0" margin="0">
<tr width="100%">
<td width="70%" align="left">
<font class="menu_h">List of churches</font>
</td>
<td width="100%" align="right">
        <li class="lpasDispo"><a href="sommaire.php">FR</a></li>
<li class="lDispo">EN</li>
        <li class="lpasDispo"><a href="sommaire_sp.php">SP</a></li>
</td>
