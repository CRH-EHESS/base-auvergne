...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocTitle">Notre-Dame-du-Port (map of the collegiate church)</xsl:variable>
    <xsl:variable name="DocFileName">NDPort</xsl:variable>
    ...
    <xsl:variable name="ScaledImageFileName">NDPort_wv_Plan de NdP_wv_zoom_N-du-Pt plan def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">NDPort_wv_zoom_Plan de NdP_wv_zoom_N-du-Pt plan def.jpg</xsl:variable>
