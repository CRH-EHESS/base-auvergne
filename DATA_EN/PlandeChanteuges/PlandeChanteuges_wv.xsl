...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:tei="http://www.tei-c.org/ns/1.0">
 ...
 <!-- 
    ...
    <xsl:variable name="DocFileName">PlandeChanteuges</xsl:variable>
    ...
    <xsl:variable name="ScaledImageFileName">PlandeChanteuges_wv_saint-marcellindeCHANTEUGES_wv_zoom_Plan de Chanteuges_wv_zoom_chanteuges plan def.jpg</xsl:variable>
    <xsl:variable name="ZoomImageFileName">PlandeChanteuges_wv_zoom_saint-marcellindeCHANTEUGES_wv_zoom_Plan de Chanteuges_wv_zoom_chanteuges plan def.jpg</xsl:variable>
