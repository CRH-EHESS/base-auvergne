...
<td width="100%" height="42" align="right">	
	<p class="lpasDispo"><a href="index.php">FR</a> <a href="index_en.php">EN</a> <a href="index_sp.php">SP</a></p>
</td>
</tr>
</table>
...
<div class="container">
  ...
  <div class="content">
    ...
    <h1 align="center"><span class="titretimes1">La Sculpture en son lieu</span><br />
	    <span class="titretimes2">Chapiteaux romans d'Auvergne</span></h1>
        
        
	
	  <p class="contenttimes">&nbsp;<br />
      Pourquoi y a-t-il, dans les églises romanes, tant de chapiteaux si diversement animés et si chargés de figures multiformes? Où se trouvent-ils placés? Comment s'agencent-ils entre eux et au sein du lieu sacré ? Pour mieux poser ces questions, le présent site propose des outils et des analyses concernant cinq églises d'Auvergne (Saint-Pierre de Mozat, Saint-Nectaire, Notre-Dame-du-Port à Clermont-Ferrand, Notre-Dame d'Orcival et Saint-Marcellin de Chanteuges)&nbsp;:</p>
    <ul>
<li class="contenttimes"><strong><a href="sommaire.php" target="_blank">Un <em>Corpus topo-photographique des chapiteaux</em></a></strong> présente, pour chaque église, un plan permettant de faire apparaître, de localiser et de comparer la totalité des chapiteaux de l'édifice. <br />
  &nbsp;</li>
              <center>
                <p><a href="sommaire.php" target="_blank"><img src="img/plan-accueil250.jpg" width="250" height="158" /></a><br />
                </p>
              </center>
      <li class="contenttimes"><strong><a href="http://imagesrevues.revues.org/1579" target="_blank"><em>Iter et Locus. </em>Lieu rituel et agencement du décor sculpté</a></strong> propose une étude d'ensemble des chapiteaux des cinq églises mentionnées et une méthodologie spécifique pour analyser l'agencement du décor sculpté, dans ses relations avec la constitution de l'édifice ecclésial.<br/>&nbsp;
      </li>
       <center><img src="img/plan-accueil250-n2.jpg" width="250" height="158" /><br />
      </center>
    </ul>
      <p class="apropos"><br/>
        &nbsp;&nbsp;
              <a href="presentation.php" alt="Présentation du site" target="_blank">Présentation du site</a> <br/>
    </p>
